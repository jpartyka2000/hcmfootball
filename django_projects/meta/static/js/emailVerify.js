...
function validate3() {
		    ...
		    if (document.signUpForm.role.value=="None")
...
function validateAssessmentItem() 
	{
		var submit_ok='true';
                ...
                if (document.getElementById('id_response').value=='')
                	{
				errmsg+="Select a response to this question.\n";
                          	submit_ok='false';
			}
	...
	function validateAssessmentRadioItem() 
	{
		var submit_ok='true';
                var errmsg='';
                if (document.getElementById('id_response').checked==true && document.getElementById('id_response').value=='Blank')
                	{
				errmsg+="Select a response to this question.\n";
                          	submit_ok='false';
			}
